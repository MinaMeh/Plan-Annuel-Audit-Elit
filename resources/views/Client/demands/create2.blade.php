...
<div class="col-md-8 grid-margin stretch-card">
  <div class="card card1 ">
    <div class="card-body">
      ...
      <form method="post" action="/demands/step2" id="demande" enctype="multipart/form-data">
          {{csrf_field()}}
                  ...
                  <tbody id="appservers">
                        <tr contenteditable='true'>
                            ...
                            <td class="text-center">
                                <button type="button" name="btn_add" class="btn btn-success btn-sm" id="btn-info" onclick="addUserServer($('#apps_list').val())">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody id="appusers">
                        <tr contenteditable='true'>
                            ...
                            <td class="text-center role"  id="role"></td>
                            <td class="text-center">
          ...
          <button  class="btn btn-dark mr-2" >
              ...
              <a style="color:#fff;" href="/Client_demandes_create"> Envoyer</a>
          </button>
