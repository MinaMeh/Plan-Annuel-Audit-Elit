      ...
      <div class="card-body">
        ...
        <form method="post" action="/demandsNPStep1" id="demandeNP" enctype="multipart/form-data">
            ...
            <div class="form-group collapse" id="INT_np" >
              ...
              <select class="form-control" name="client_np" id="client_np">
                <option value="-1" selected></option>
            ...
            <div class="form-group">
              <label for="techs_np" class="font-weight-bold"> Technologies utilisées</label>
                <div class="form-check form-check-flat">
                  ...
                  <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="autre" id="autre"> Autres
                      </label>
                  </div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="version_np" class="form-control"  required>                            
            </div>
            <div class="form-group">
              <label for="chef_projet_np" class="font-weight-bold"> Chef du projet</label>
              <input type="text" required class="form-control" name="chef_projet_np" id="chef_projet_np">                            
            </div>
            <div class="form-group">
