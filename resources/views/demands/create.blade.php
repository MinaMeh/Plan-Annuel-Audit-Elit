	    ...
	    <div class="card card1 ">
		    <div class="card-body">
		        ...
		        <form method="post" action="/demands/step1" id="demande" enctype="multipart/form-data">
		            ...
		            <div class="form-group">
		            	<label class="font-weight-bold">Changer le nom de l'application</label>
		            ...
		            <div class="form-group">
			            ...
			            <div class="input-group col-xs-12 custom">
			                <input type="text" class="form-control" disabled placeholder="Documentation" name="documentation_np"accept="application/pdf image/* .doc,.docx,.xml,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document .zip .rar" id="documentation_np" required>
