<div class="modal fade" id="deleteTech" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	        ...
	        <div class="modal-body">
		        ...
		        <form id="tech_delete" method="post" action="/technologies/supprimer">
		        	{{csrf_field()}}
	        ...
	        <div class="modal-footer">
		        ...
		        <button type="button" onclick="$('#tech_delete').submit()" class="btn btn-danger"><span class="mdi mdi-delete"></span> Supprimer</button>
	        </div>
	    </div>
	</div>
</div>
